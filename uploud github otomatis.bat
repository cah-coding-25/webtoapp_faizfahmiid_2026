...
:: 1. Melacak Git Portable di Flashdisk Drive D sampai Z
set "GIT_PATH="
...
:: 3. Membaca Identitas Otomatis (Jika sudah ada data asli)
if exist "akun.txt" (
...
:: 4. INPUT LINK LANGSUNG (Selalu Ditanyakan Setiap Klik, Tanpa Membaca repo.txt)
